 ...
 *
 *        Version:  1.0
 *        Created:  11/09/2009 07:08:10 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 ...
 * =====================================================================================
 */
#ifndef __TTC_PLUGIN_GLOBAL_H__
#define __TTC_PLUGIN_GLOBAL_H__
...
#define TTC_API_SO_FILE         "../bin/libdtc.so"

#define DLFUNC_NO_ERROR(h, v, type, name) do { \
    v = (type)dlsym (h, name); \
    dlerror (); \
}while (0)

#define DLFUNC(h, v, type, name) do { \
    v = (type)dlsym (h, name); \
...
class CPluginGlobal : private noncopyable
{
public:
    CPluginGlobal (void);
    ~CPluginGlobal (void);
